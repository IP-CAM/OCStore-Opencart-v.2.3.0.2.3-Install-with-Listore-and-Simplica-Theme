...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php } ?>
			 ...
			 class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="row">
        <?php if ($column_left || $column_right) { ?>
        <?php $class = 'col-sm-6'; ?>
        <?php } else { ?>
        ...
        <div class="<?php echo $class; ?>">
          ...
          <ul class="thumbnails">
            ...
            <li><a class="thumbnail" href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>">
				<img src="<?php echo $thumb; ?>" itemprop="image"
			 title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a></li>
            <?php } ?>
            <?php if ($images) { ?>
      ...
      <div class="row">
        ...
        <div class="<?php echo $class; ?>">
				...
				<div itemprop="isRelatedTo" itemscope itemtype="http://schema.org/Product" class="product-thumb
			 transition">
            <div class="image"><a href="<?php echo $product['href']; ?>">
				<img src="<?php echo $product['thumb']; ?>" itemprop="image"

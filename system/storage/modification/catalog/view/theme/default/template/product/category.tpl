      ...
      <div class="row">
            ...
            <select id="input-limit" class="form-control" onchange="location = this.value;">
              ...
              <?php } ?>
				...
				<div itemtype="http://schema.org/ItemList" itemscope>
					<div itemprop="name" content='<?php echo $heading_title; ?>' class="row
			">
        ...
        <div class="product-layout product-list col-xs-12">
            ...
            <div class="image"><a href="<?php echo $product['href']; ?>">
				<img itemprop="image" src="<?php echo $product['thumb']; ?>
			" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-responsive" /></a></div>
            <div>
              <div class="caption">
                <h4>
				<a itemprop="url" href="<?php echo $product['href']; ?>"><span itemprop="name"><?php echo $product['name']; ?></span></a>
			</h4>
